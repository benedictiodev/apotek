...
@section('main')
  <div class="">
    <div class="mb-4">
      ...
      <h1 class="text-xl font-semibold text-gray-900 sm:text-2xl mb-4">Tambahkan Kategori Produk</h1>
    ...
    <div
      ...
      <div class="mb-4">
        <form action="{{ route('dashboard.master-data.product-category.store') }}" method="POST" enctype="multipart/form-data">
          @csrf
          <div class="space-y-2">
            <div>
              ...
              <input type="text" name="name" id="name"
                ...
                placeholder="Nama Kategori Produk" required>
            </div>

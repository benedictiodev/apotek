...
@section('main')
  <div>
    <div class="mb-4">
      ...
      <h1 class="text-xl font-semibold text-gray-900 sm:text-2xl mb-4">Pembaruan Kategori Produk</h1>
    ...
    <div
      ...
      <div>
        <form action="{{ route('dashboard.master-data.product-category.update', ['id' => $data->id]) }}" method="POST"
          ...
          <div class="space-y-6">
            <div>
              ...
              <input type="text" name="name" id="name"
                ...
                placeholder="Nama Kategori Produk" required value="{{ old('name', $data->name) }}">
            </div>

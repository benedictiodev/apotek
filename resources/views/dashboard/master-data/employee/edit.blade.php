...
@section('main')
  <div>
    <div class="mb-4">
      ...
      <h1 class="text-xl font-semibold text-gray-900 sm:text-2xl mb-4">Pembaruan Karyawan</h1>
    ...
    <div
      ...
      <div>
        <form action="{{ route('dashboard.master-data.employee.update', ['id' => $data->id]) }}" method="POST"
          ...
          <div class="space-y-6">
            <div>
              ...
              <input type="text" name="code" id="code"
                ...
                placeholder="Kode Karyawan" required value="{{ old('code', $data->code) }}">
            </div>
            ...
            <div>
              ...
              <input type="text" name="name" id="name"
                class="block w-full rounded-lg border border-gray-300 p-2.5 text-sm text-gray-900 focus:border-primary-600 focus:ring-primary-600"
                placeholder="Nama Karyawan" required value="{{ old('name', $data->name) }}">
            </div>

...
@section('main')
  <div>
    ...
    <div class="p-4 bg-white rounded-lg shadow-lg 2xl:col-span-2 sm:p-6 mb-4">
      <div class="block items-center justify-between sm:flex md:divide-x md:divide-gray-100 mb-4">
        <div class="mb-4 flex items-center sm:mb-0">
          <form class="sm:pr-3" action="{{ route('dashboard.master-data.supplier') }}" method="GET">
            ...
            <div class="relative mt-1 w-48 sm:w-64 xl:w-96">
              <input type="text" name="search" id="supliers-search"
                ...
                placeholder="Cari Supplier" @if (isset($_GET['search'])) value="{{ $_GET['search'] }}" @endif>
            </div>
          </form>
        ...
        {{-- @can('master data-produk-tambah') --}}
          <a id="createSupplierButton"
            ...
            href="{{ route('dashboard.master-data.supplier.create') }}">
            Tambahkan Supplier
          </a>
        {{-- @endcan --}}
      </div>
                    ...
                    <tr class="hover:bg-gray-100">
                      ...
                      <td class="text-center space-x-2 whitespace-nowrap p-4">
                        {{-- @can('master data-produk-perbarui') --}}
                          <a href="{{ route('dashboard.master-data.supplier.edit', ['id' => $item->id]) }}"
                            id="updateSupplierButton" data-drawer-target="drawer-update-supplier-default"
                            data-drawer-show="drawer-update-supplier-default" aria-controls="drawer-update-supplier-default"
                        ...
                        {{-- @can('master data-produk-hapus') --}}
                          <button type="button" id="deleteSupplierButton"
                            data-drawer-target="drawer-delete-supplier-default"
                            data-drawer-show="drawer-delete-supplier-default" aria-controls="drawer-delete-supplier-default"
                            data-drawer-placement="right"
    ...
    <!-- Delete Supplier Drawer -->
    <div id="drawer-delete-supplier-default"
      ...
      <button type="button" data-drawer-dismiss="drawer-delete-supplier-default"
        aria-controls="drawer-delete-supplier-default"
      ...
      <form id="form-delete">
        ...
        <button type="button"
          ...
          data-drawer-hide="drawer-delete-supplier-default">
          Tidak, Batalkan
        </button>
      </form>
    </div>
  ...
  <script type="text/javascript">
    window.onload = () => {
      document.addEventListener('click', async (event) => {
        // DELETE DATA
        if (event.target.getAttribute('data-drawer-target') == "drawer-delete-supplier-default") {
        ...
        if (event.target.getAttribute('data-type') == "button-delete") {
          ...
          document.querySelector("#form-delete").action =
            `/dashboard/master-data/supplier/${id}`;

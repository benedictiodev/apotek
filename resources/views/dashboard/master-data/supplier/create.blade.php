...
@section('main')
  <div class="">
    ...
    <div
      ...
      <div class="mb-4">
        <form action="{{ route('dashboard.master-data.supplier.store') }}" method="POST" enctype="multipart/form-data">
          @csrf
          <div class="space-y-2">
            <div>
              <label for="code" class="mb-2 block text-sm font-medium text-gray-900">Kode Supplier</label>
            ...
            <div>
              <label for="name" class="mb-2 block text-sm font-medium text-gray-900">Nama Supplier</label>

              ...
              <div class="relative bg-white rounded-lg shadow">
                ...
                <div class="p-4 md:p-5 space-y-4">
                  ...
                  <div id="payment_form" class="border pl-4 pr-2 py-4 rounded-lg relative">
                    ...
                    <div class="mb-3">
                      <label for="total_price_item" class="mb-2 block text-sm font-medium text-gray-900">
                        Total Harga  
                      </label>
                    ...
                    <div class="mb-3 flex justify-between">
                      <div class="w-1/3 mr-2">
                        <label for="discount" class="mb-2 block text-sm font-medium text-gray-900">
                          Diskon (%)  
                        </label>
                        <input type="text" min="0" name="discounts"
                          id="discount"
                          class="block w-full rounded-lg border border-gray-300 bg-gray-50 p-2.5 text-sm text-gray-900 focus:border-primary-600 focus:ring-primary-600"
                          placeholder="Diskon" onkeyup="change_discount()" value="0">
                      </div>
                      <div class="w-2/3 ml-2">
                        <label for="total_discount" class="mb-2 block text-sm font-medium text-gray-900">
                          Total Diskon
                        </label>
                    ...
                    <div class="mb-3">
                      <label for="total_payment" class="mb-2 block text-sm font-medium text-gray-900">
                        Total Harga Yang Harus Dibayar  
                      </label>
                      <input type="text" min="0" name="total_payment"
                        id="total_payment"
                        class="block w-full rounded-lg border border-gray-300 bg-gray-50 p-2.5 text-sm text-gray-900 focus:border-primary-600 focus:ring-primary-600"
                    ...
                    <div class="">
                      <label for="change" class="mb-2 block text-sm font-medium text-gray-900">Kembalian</label>
...
<div id="product-modal" class="fixed inset-0 z-50 hidden items-center justify-center bg-black/50 p-4">
  <div class="w-full max-w-3xl rounded-xl bg-white shadow-2xl">
    <div class="flex items-center justify-between border-b p-5">
      ...
      <button type="button" onclick="closeProductModal()" class="rounded-lg px-3 py-2 text-gray-500 hover:bg-gray-100">
        ✕
      </button>
    </div>
